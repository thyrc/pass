...
<section class="section">
    <div class="container">
        <div class="notification is-info is-light">
            ...
            <div class="content is-small">With <?= esc($_SERVER['SERVER_NAME']) ?> you can securely share (small) secrets, like passwords and tiny code snippets, with your colleagues. Just input your secret into the textarea below and press 'Submit'. This tool will 'wrap' your secret in a link - which can be sent via Teams, e-mail or whatever service you choose.<br>With this link your colleague can retrieve your secret <strong>once</strong> (and only once) within the next <strong>6 hours</strong>.</div>
        </div>
