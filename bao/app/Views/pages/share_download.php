<section class="section">
    ...
    <?php } else {?>
        <div class="notification is-success is-light" id="download-notification">
        ...
        <article class="message">
            <div class="message-body">
                https://<?= $_SERVER['SERVER_NAME'] ?>/download/<?= esc((isset($token) ? trim($token, '"') : '')) . PHP_EOL; ?>
            </div>
        </article>
        ...
        <article class="message">
            <div class="message-body">
                https://<?= getenv('BAO_AUTH_USER') . ":" . getenv('BAO_AUTH_PW') . "@" . $_SERVER['SERVER_NAME'] ?>/download/<?= esc((isset($token) ? trim($token, '"') : '')) . PHP_EOL; ?>
            </div>
        </article>
        <?php }?>
        <?php if (isset($until)) {?>
