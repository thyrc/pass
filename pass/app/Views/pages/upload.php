    ...
    <div class="container">
        <div class="notification is-info is-light">
            ...
            <div class="content is-small">
                You can upload small files (up to 20 MB) and - like any other secret shared via <?= esc($_SERVER['SERVER_NAME']) ?> - these files can be retrieved <strong>once</strong> (and only once) within the next <strong>2 hours</strong> using the generated link.
            </div>
        </div>
